    ...
    <>
      ...
      <div className="signupbox">
        ...
        <form onSubmit={handleSubmit}>
          ...
          />
          {errors.firstName && <span id="error-fname" className="text-danger">{errors.firstName}</span>}
          ...
          <input
            ...
            onChange={handleInput}
          />
          {errors.lastName && <span id="error-lname" className="text-danger">{errors.lastName}</span>}
          ...
          <input
            ...
            onChange={handleInput}
          />
          {errors.username && <span id="error-uname" className="text-danger">{errors.username}</span>}
          ...
          <input
            ...
            onChange={handleInput}
          />
          {errors.email && <span id="error-email" className="text-danger">{errors.email}</span>}
          ...
          <input
            ...
            onChange={handleInput}
          />
          {errors.password && <span id="error-password" className="text-danger">{errors.password}</span>}
          
          <button id="complete" type="submit" disabled={isSubmitting}>complete</button>
        </form>
      </div>
    </>
  );
